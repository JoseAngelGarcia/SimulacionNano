...
barplot(as.matrix(t(datos1)), beside = T , col= rainbow(9) ,main = "Teoría de Colas", ylab = "Promedio de Tiempo", xlab ="núcleos", ylim = (c(0, max(as.matrix(t(datos1))))) )
